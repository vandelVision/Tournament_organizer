...
import { Calendar, Clock, Users, Trophy, MapPin, DollarSign, Award } from "lucide-react";
...
const tournamentsData = [
  {
    ...
    description: "Join the most prestigious VALORANT tournament of the season. Compete against the best teams and prove your worth in the arena.",
    prizePool: "$10,000",
    entryFee: "$50",
    maxTeams: 32,
    registeredTeams: 24,
  ...
  },
  {
    ...
    description: "Battle it out in the Phantom Arena Series for glory and rewards.",
    prizePool: "$5,000",
    entryFee: "$25",
    maxTeams: 16,
    registeredTeams: 12,
  ...
  },
  {
    ...
    description: "The Rebels Showdown brings together competitive teams for an intense tournament.",
    prizePool: "$7,500",
    entryFee: "$30",
    maxTeams: 24,
    registeredTeams: 18,
  ...
  },
  {
    ...
    description: "Master the spike and dominate your opponents in this thrilling competition.",
    prizePool: "$15,000",
    entryFee: "$75",
    maxTeams: 32,
    registeredTeams: 20,
  ...
  },
  {
    ...
    description: "An exclusive invitational tournament featuring top-tier teams.",
    prizePool: "$20,000",
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#1B2430] via-[#212A37] to-[#0D1117] text-white font-orbitron flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-[#ff4655] mb-4">Tournament Not Found</h1>
          <button
      ...
      <div className="px-6 py-20 pt-28 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              <h2 className="text-2xl font-bold text-[#ff4655] mb-4">About Tournament</h2>
            ...
            {tournament.rules && (
              <motion.div
                ...
                className="bg-[#1E2837] rounded-2xl p-6 border border-[#2a2f3a]"
              >
                <h2 className="text-2xl font-bold text-[#ff4655] mb-4">Rules & Requirements</h2>
            ...
            {tournament.schedule && (
              <motion.div
                ...
                className="bg-[#1E2837] rounded-2xl p-6 border border-[#2a2f3a]"
              >
                <h2 className="text-2xl font-bold text-[#ff4655] mb-4">Schedule</h2>
                <div className="space-y-3">
                  {tournament.schedule.map((item, index) => (
                    <div key={index} className="flex justify-between items-center border-b border-[#2a2f3a] pb-3">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-sm text-gray-400">
                {spotsLeft > 0 ? `${spotsLeft} spots remaining` : "Tournament Full"}
              </p>
